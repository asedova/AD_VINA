...
function AD_VINA(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    ...
    var _auth_cb = auth_cb;
     ...
     this.ad_vina = function (inparams, _callback, _errorCallback) {
        if (typeof inparams === 'function')
            throw 'Argument inparams can not be a function';
        ...
        return json_call_ajax(_url, "AD_VINA.ad_vina",
            [inparams], 1, _callback, _errorCallback);
    };
