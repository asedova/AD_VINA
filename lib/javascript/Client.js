...
function AD_VINA(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.ad_vina = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "AD_VINA.ad_vina",
            [params], 1, _callback, _errorCallback);
    };
 
     this.mol2_to_pdbqt = function (mol2_file_path, compound_id, _callback, _errorCallback) {
        if (typeof mol2_file_path === 'function')
            throw 'Argument mol2_file_path can not be a function';
        if (typeof compound_id === 'function')
            throw 'Argument compound_id can not be a function';
        if (_callback && typeof _callback !== 'function')
            throw 'Argument _callback must be a function if defined';
        if (_errorCallback && typeof _errorCallback !== 'function')
            throw 'Argument _errorCallback must be a function if defined';
        ...
        return json_call_ajax(_url, "AD_VINA.mol2_to_pdbqt",
            [mol2_file_path, compound_id], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "AD_VINA.status",
