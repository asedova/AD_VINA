...
sub new
{
    ...
    my $self = {
	client => AD_VINA::AD_VINAClient::RpcClient->new,
	url => $url,
	headers => [],
    };
...
sub _validate_version {
    ...
    if ($sMinor > $cMinor) {
        warn "New client version available for AD_VINA::AD_VINAClient\n";
    }
    if ($sMajor == 0) {
        warn "AD_VINA::AD_VINAClient version is $svr_version. API subject to change.\n";
    }
}
...
package AD_VINA::AD_VINAClient::RpcClient;
